...
from pointer_decoder import pointer_decoder
  ...
  def step(self):
    ...
    with tf.Session() as sess:
      ...
      for i in range(10000):
        ...
        feed_dict = self.create_feed_dict(
          encoder_input_data, decoder_input_data, targets_data)
        _ = sess.run(self.inps, feed_dict=feed_dict)
...
if __name__ == "__main__":
  pointer_network = PointerNetwork(max_len=FLAGS.max_steps, input_size=1, size=FLAGS.rnn_size,
                   num_layers=1, batch_size=FLAGS.batch_size, learning_rate=1e-2,
